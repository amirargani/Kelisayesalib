                ...
                if (Image != null)
                {
                    if (Image.ContentType == "image/jpeg")
                    {
                        if (Image.Length <= 1048576) // 1 MB -> 1048576 Bit
                        {
                            ...
                            var deleteimage = Path.Combine(_environment.WebRootPath, "uploads\\images\\details\\church\\" + detail.Image);
