...
namespace APPClinet.Areas.Identity.Pages.Account.Dashboard.Admin.Details
{
    ...
    public class GalleryImageAddModel : PageModel
    {
        ...
        public GalleryImageAddModel(APPClinetDbContext db,
        ...
        {
            var details = await _db.Tbl_GalleryDetails.FirstOrDefaultAsync(c => c.Id.Equals(id));
            ...
            if (Image != null)
            {
                if (Image.ContentType == "image/jpeg")
                {
                    if (Image.Length <= 1048576) // 1 MB -> 1048576 Bit
                    {
                        ...
                        int count = _db.Tbl_GalleryImages.Count();
                        ...
                        _db.Tbl_GalleryImages.Add(image);
