...
namespace APPClinet.Areas.Identity.Pages.Account.Dashboard.Admin.Details
{
    ...
    public class CourseDetailEditModel : PageModel
    {
        ...
        {
            var detail = _db.Tbl_CourseDetails.Where(a => a.Id.Equals(id)).FirstOrDefault();
            if (detail == null)
            {
                return Redirect(Url.Content("~/") + "Identity/Account/Dashboard/Admin/SubCategories/CourseSubCategoriesView");
            }
            var subcategories = await _db.Tbl_CourseSubCategories.FirstOrDefaultAsync(c => c.Id.Equals(detail.SubCategoryId));
            var categories = await _db.Tbl_CourseCategories.FirstOrDefaultAsync(c => c.Id.Equals(detail.CategoryId));
            ...
            if (Input.Text != null)
            {
                ...
                if (ImageLink != null)
                {
                    if (ImageLink.ContentType == "image/jpeg")
                    {
                        ...
                        {
                            var deleteimagelink = Path.Combine(_environment.WebRootPath, "uploads\\images\\details\\courses\\" + detail.ImageLink);
                            ...
                            if (Image != null)
                            {
                                if (Image.ContentType == "image/jpeg")
                                {
                                    ...
                                    {
                                        var deleteimage = Path.Combine(_environment.WebRootPath, "uploads\\images\\details\\courses\\" + detail.Image);
                                        ...
                                        _db.Tbl_CourseDetails.Update(detail);
