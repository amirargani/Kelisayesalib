...
namespace APPClinet.Migrations
{
    ...
    partial class APPClinetDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_CourseCategories");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_CourseDetails");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseSubCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_CourseSubCategories");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseVideos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_NewCategories");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_NewDetails");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_NewImages");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewSubCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Tbl_NewSubCategories");
                });
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Settings.Footer.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Settings.Footer.SocialNetworks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseDetails", b =>
                {
                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseCategories", "Tbl_CourseCategories")
                        .WithMany("Tbl_CourseDetails")
                        .HasForeignKey("CategoryId");

                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseSubCategories", "Tbl_CourseSubCategories")
                        .WithMany("Tbl_CourseDetails")
                        .HasForeignKey("SubCategoryId");
                    ...
                    b.Navigation("Tbl_CourseCategories");

                    b.Navigation("Tbl_CourseSubCategories");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseSubCategories", b =>
                {
                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseCategories", "Tbl_CourseCategories")
                        .WithMany("Tbl_CourseSubCategories")
                        .HasForeignKey("CategoryId");
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseVideos", b =>
                {
                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseCategories", "Tbl_CourseCategories")
                        .WithMany("Tbl_CourseVideos")
                        .HasForeignKey("CategoryId");

                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.Courses.CourseDetails", "Tbl_CourseDetails")
                        .WithMany("Tbl_CourseVideos")
                    ...
                    b.Navigation("Tbl_CourseDetails");
            ...
            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewDetails", b =>
                {
                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewCategories", "Tbl_NewCategories")
                        .WithMany("Tbl_NewDetails")
                        .HasForeignKey("CategoryId");

                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewSubCategories", "Tbl_NewSubCategories")
                        .WithMany("Tbl_NewDetails")
                        .HasForeignKey("SubCategoryId");
                    ...
                    b.Navigation("Tbl_NewCategories");

                    b.Navigation("Tbl_NewSubCategories");
                });

            modelBuilder.Entity("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewImages", b =>
                {
                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewCategories", "Tbl_NewCategories")
                        .WithMany("Tbl_NewIamges")
                        .HasForeignKey("CategoryId");

                    b.HasOne("APPClinet.Areas.Identity.Data.Models.Categories.Church.News.NewDetails", "Tbl_NewDetails")
                        .WithMany("Tbl_NewIamges")
                        .HasForeignKey("DetailId");
